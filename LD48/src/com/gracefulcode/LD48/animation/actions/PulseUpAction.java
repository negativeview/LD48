...
public class PulseUpAction extends BaseAction {
	public PulseUpAction(int pulseSize, float pulseDuration, int difference, GameLevel level) {
	...
	public boolean act(float delta) {
		...
		if (done) {
			...
			TileActor actor2 = actor.level.getTile(actor.x, actor.y + 1);
			if (actor2 != null) {
